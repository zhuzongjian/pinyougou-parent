...
public class SellerServiceImpl implements SellerService {
	...
	public PageInfo findPage(Integer pageNum, Integer pageSize) {
		...
		return new PageInfo<TbSeller>(sellerMapper.selectByExample(null));
	}
	 ...
	 */
	@Override
	public PageInfo findPage(TbSeller seller, Integer pageNum, Integer pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		...
		//return new PageResult(page.getTotal(), page.getResult());
		return new PageInfo<TbSeller>(sellerMapper.selectByExample(example));
	}
