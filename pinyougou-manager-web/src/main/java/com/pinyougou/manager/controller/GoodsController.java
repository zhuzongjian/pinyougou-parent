...
public class GoodsController {
	 ...
	 */
	/*
	 * @RequestMapping("/add") public ResponseResult add(@RequestBody TbGoods
	 * goods){ try { goodsService.add(goods); return new ResponseResult(true,
	 * "增加成功"); } catch (Exception e) { e.printStackTrace(); return new
	 * ResponseResult(false, "增加失败"); } }
	 */
