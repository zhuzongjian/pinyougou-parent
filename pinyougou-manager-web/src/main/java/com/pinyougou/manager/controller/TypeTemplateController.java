...
public class TypeTemplateController {
	 ...
	 */
	@RequestMapping("/add")
	public ResponseResult add(@RequestBody TbTypeTemplate typeTemplate){
		try {
	...
	public ResponseResult update(@RequestBody TbTypeTemplate typeTemplate){
		try {
	...
	public PageInfo searchPage(@RequestBody TbTypeTemplate typeTemplate, Integer pageNum, Integer pageSize  ){
		return typeTemplateService.findPage(typeTemplate, pageNum, pageSize);		
	}

	@RequestMapping("/select2type_template")
	public List<Map> select2type_template(){
		return typeTemplateService.select2type_template();
	}
}
